	...
	<?php } ?>
		<?php echo form_open_multipart('app_admin_data_pemilih/simpan','class="form-horizontal"'); ?>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				<input type="text" style="width:300px;" name="nik_ktp" value="<?php echo $nik_ktp; ?>">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Nama Lengkap</label>
			<div class="controls">
				<input type="text" style="width:300px;" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Tempat Lahir</label>
			<div class="controls">
				<input type="text" style="width:300px;" name="tempat_lahir" value="<?php echo $tempat_lahir; ?>">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Tanggal Lahir</label>
			<div class="controls">
				<input type="text" style="width:300px;" name="tanggal_lahir" placeholder="Tanggal-Bulan-Tahun" value="<?php echo $tanggal_lahir; ?>">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Umur</label>
			<div class="controls">
				<input type="text" style="width:300px;" name="umur" value="<?php echo $umur; ?>">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Status Perkawinan</label>
			<div class="controls">
				<input type="text" style="width:300px;" name="stts_perkawinan" value="<?php echo $stts_perkawinan; ?>">
			</div>
		  </div>
		  <div class="control-group">
		  <?php
		  ...
		  ?>
			...
			<div class="controls">
			<label class="radio">
				<input type="radio" name="kelamin" value="laki" <?php echo $laki; ?>>Laki-Laki
			</label>
			<label class="radio">
				<input type="radio" name="kelamin" value="wanita" <?php echo $wanita; ?>>Wanita
			</label>
			</div>
		  </div>
		  <div class="control-group">
			...
			<div class="controls">
				<textarea style="width:350px; height:200px;" name="alamat"><?php echo $alamat; ?></textarea>
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="nama_hukuman">Keterangan</label>
			<div class="controls">
				<textarea style="width:350px; height:200px;" name="keterangan"><?php echo $keterangan; ?></textarea>
			</div>
		  </div>
		  <div class="control-group">
			<div class="controls">
