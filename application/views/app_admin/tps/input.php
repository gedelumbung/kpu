	...
	<?php } ?>
		<?php echo form_open('app_admin_tps/simpan','class="form-horizontal"'); ?>
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span" name="nama_tps" id="nama_tps" value="<?php echo $nama_tps; ?>" placeholder="Nama TPS">
			</div>
		  </div>
		  <div class="control-group">
			...
			<div class="controls" id="datatps">
				<?php
					if($st=="edit")
					{
						...
						?>
						<select data-placeholder="Pilih Kelurahan..." class="chzn-select3" style="width:300px;" tabindex="2" name="id_kelurahan_desa" id="id_kelurahan_desa">
							<option value=""></option>
							<?php
