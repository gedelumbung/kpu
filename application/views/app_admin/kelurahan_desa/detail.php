	...
	<?php } ?>
		<?php echo form_open('app_admin_kelurahan_desa/simpan','class="form-horizontal"'); ?>
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span" name="nama_kelurahan_desa" id="nama_kelurahan_desa" value="<?php echo $nama_kelurahan_desa; ?>" placeholder="Nama Kelurahan/Desa" disabled>
			</div>
		  </div>
		  <div class="control-group">
