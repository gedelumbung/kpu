...
$(function(){
	...
	if(confirm("Anda yakin akan menghapus?"))
	{
		...
		$.ajax({
			url:'<?php echo base_url(); ?>app_admin_kelurahan_desa/hapus_multiple',
			data:"kode="+id_array,
			type:"POST",
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Data Kelurahan/Desa</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>app_admin_kelurahan_desa/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Data Kelurahan/Desa</a></li>
			</ul>
		  </div>
		<div class="span5 pull-right">
		<?php echo form_open("app_admin_kelurahan_desa/cari",'class="navbar-form pull-right"'); ?>
	  ...
	  <section>
	<?php echo form_open("app_admin_kelurahan_desa/set",'name="frm_filter"'); ?>
	<p class="span3">
		Kabupaten :
  ...
  <table class="table table-hover table-condensed">
	...
	?>
      <tr>
        <td>
		<input type="checkbox" name="chk[]" id="chk-<?php echo $no2; ?>" class="chk" value="<?php echo $dp['id_kelurahan_desa']; ?>" />
		</td>
        <td><?php echo $no; ?></td>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?php echo base_url(); ?>app_admin_kelurahan_desa/detail/<?php echo $dp['id_kelurahan_desa']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo base_url(); ?>app_admin_kelurahan_desa/edit/<?php echo $dp['id_kelurahan_desa']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?php echo base_url(); ?>app_admin_kelurahan_desa/hapus/<?php echo $dp['id_kelurahan_desa']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
