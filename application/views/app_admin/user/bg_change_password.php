  ...
  <div class="well">
	...
	?>
	  <ul class="nav nav-tabs">
		...
		<li><a href="<?php echo base_url(); ?>app_admin/logout">Log Out</a></li>
	  </ul>
	  <div class="tab-content">
		<div class="tab-pane <?php echo $a; ?>" id="lA">
		  <h4>Pengaturan Password</h4>
			<?php echo form_open('app_admin/save_pass'); ?>
		...
		<div class="tab-pane <?php echo $b; ?>" id="lB">
		  <h4>Pengaturan Nama Pengguna</h4>
			  <?php echo form_open('app_admin/save_name'); ?>
					<div class="control-group">
						<label class="control-label" for="pass_lama">Nama Pengguna</label>
						<div class="controls">
						  <input type="text" value="<?php echo $this->session->userdata('nama_pengguna'); ?>" 
