...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?php echo form_open('app_admin_manage_user/simpan','class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Manajemen User</legend>
			<label class="control-label" for="nama_unit_kerja">Nama Pengguna</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_pengguna" id="nama_pengguna" value="<?php echo $nama_pengguna; ?>" placeholder="Nama Pengguna">
			</div>
		  </div>
		  <div class="control-group">
